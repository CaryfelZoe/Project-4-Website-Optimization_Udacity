...
var resizePizzas = function(size) { 
  ...
  // Changes the value for the size of the pizza above the slider
    // I change all the document.querySelector for document.getElementById to avoid the DOM being queried (which is expensive) everytime changeSliderLabel is called.
  ...
  function changePizzaSizes(size) {
    var newwidth;
     switch(size) {
      ...
      // I change the document.querySelectorAll to document.getElementsByClassName for more efficiency.
...
// I change document.querySelectorAll document.getElementsByClassName for more efficiency.
  var items = document.getElementsByClassName("mover");
    //I  get this query outside of the for lop
...
// I change document.querySelector to document.getElementById for more efficiency.
